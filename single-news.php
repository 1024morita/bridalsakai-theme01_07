...
if ($terms) {
  foreach ( $terms as $term ) {
    $term_output .= '<p class="cate">'.esc_html($term->name).'</p>';
  }
}
?>
...
<header class="h2_style">
  <h2 class="h2_font"><?php echo esc_html($terms[0]->name); ?></h2>
</header>
<section class="container">
  ...
  <section class="contents">
    ...
    <section class="clearfix postdata top-mg-40  bottom-mg-40">
      ...
      <p><?php echo nl2br( get_field( 'sentence_01', $post->ID ) ); ?></p>
    </section>
    <?php } ?>
    <!-- h3+contents end -->
    <!-- h4+contents start -->
    ...
    <section class="clearfix postdata bottom-mg-40">
      ...
      <p><?php echo nl2br( get_field( 'sentence_02', $post->ID ) ); ?></p>
    </section>
    <?php } ?>
    <!-- h4+contents end -->
    <!-- digest start -->
    ...
    <section class="clearfix postdata bottom-mg-40">
      ...
      <p><?php echo nl2br( get_field( 'digest', $post->ID ) ); ?></p>
    </section>
    <?php } ?>
    <!-- digest end -->
    <!-- 投稿見出しここまで -->
    ...
    <article class="chunk_40-20 clearfix">
      <ul class="pager">
        ...
        <li class="return"> <a href="<?php echo esc_url(get_term_link($terms[0], 'news_category'));?>">一覧へ</a> </li>
        <li class="next">
